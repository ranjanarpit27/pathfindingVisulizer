  ...
  render() { 
    return (
      <div className="PopUpTextBox">
        <header>
          <p><h4>Welcome to Dijkstra Search Visualizer</h4></p>
        ...
        <div className="PopUpIntroductionText">
          ...
          <div className="player">
            ...
            <div style={{backgroundColor:'hsl(150, 100%, 50%)'}} name="wall"></div>

            <label htmlFor="wall">Visited Node : </label>
            <div style={{backgroundColor: 'hsl(263, 100%, 52%)'}} name="wall"></div>
